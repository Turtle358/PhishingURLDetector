To install the firefox addon go to about:debugging#/runtime/this-firefox, "Load temporary addon" then navigagte to the repo and into firefoxExtension and import manifest.json
